...
import { Keberatan, Settings } from '../../types';
...
const DaftarKeberatan: React.FC<DaftarKeberatanProps> = ({ keberatanList, onDelete, onStatusChange, settings }) => {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="overflow-x-auto">
                    <table className="min-w-full leading-normal">
                        <thead>
                            <tr>
                                <th className="px-5 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">No. Permohonan</th>
                                <th className="px-5 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Nama Pemohon</th>
                                <th className="px-5 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Alasan</th>
                                <th className="px-5 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Tanggal</th>
                                <th className="px-5 py-3 border-b border-gray-200 bg-gray-50 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">Status</th>
                                <th className="px-5 py-3 border-b border-gray-200 bg-gray-50 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <Modal isOpen={!!selectedKeberatan} onClose={() => setSelectedKeberatan(null)} maxWidth="max-w-4xl">
                    <div className="text-left">
                        ...
                        <div className="max-h-[60vh] overflow-y-auto pr-2">
                            <table className="w-full">
                                <tbody>
                                    ...
                                    <tr className="bg-orange-50"><td colSpan={2} className="py-2 px-4 font-bold text-orange-800 uppercase text-xs tracking-wider">Identitas Pemohon</td></tr>
                                    ...
                                    <tr className="bg-gray-100"><td colSpan={2} className="py-2 px-4 font-bold text-gray-800 uppercase text-xs tracking-wider">Identitas Kuasa (Jika Ada)</td></tr>
                                    ...
                                    <tr className="bg-orange-50"><td colSpan={2} className="py-2 px-4 font-bold text-orange-800 uppercase text-xs tracking-wider">Detail Keberatan</td></tr>
                        ...
                        <div className="mt-6 flex justify-end gap-3">
                             <button onClick={() => setSelectedKeberatan(null)} className="bg-slate-800 hover:bg-slate-900 text-white font-bold py-2 px-6 rounded-lg transition-colors">Tutup</button>
                        </div>
                    </div>
                </Modal>
            )}
